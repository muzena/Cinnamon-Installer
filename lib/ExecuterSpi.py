...
class SpiceExecuter(GObject.GObject):
    __gsignals__ = {
        ...
        'EmitDownloadPercentChild': (GObject.SIGNAL_RUN_FIRST, None, (GObject.TYPE_STRING, GObject.TYPE_STRING, int, GObject.TYPE_STRING,)),
    ...
    def refresh_cache(self, collect_type, load_assets=False):
